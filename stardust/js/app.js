(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".header__swiper-left")) new core(".header__swiper-left", {
            ...
            if (document.querySelector(".header__swiper-right")) new core(".header__swiper-right", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".project__swiper-right")) new core(".project__swiper-right", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".project__swiper-middle")) new core(".project__swiper-middle", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".project__swiper-left")) new core(".project__swiper-left", {
                modules: [ Navigation, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".about__sliders__top")) new core(".about__sliders__top", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".about__sliders__bottom")) new core(".about__sliders__bottom", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
...
***************************************************************************** */
        ...
        let menuBurger = document.querySelector(".navigation__menu-burger");
        var menu = document.querySelector(".navigation__wrapper");
        menuBurger.addEventListener("click", (function() {
            menu.classList.toggle("navigation__wrapper--active");
            menuBurger.classList.toggle("navigation__menu-burger--open");
        }));
