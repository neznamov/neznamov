 ...
 */
    ...
    (() => {
        ...
        let navigationDisplayOn = document.querySelector(".navigation__wrapper");
        function menuInit() {
        ...
        let formValidate = {
            ...
            addError(formRequiredItem) {
                ...
                if (formRequiredItem.dataset.error) formRequiredItem.parentElement.querySelector("label").classList.add("error");
            },
            removeError(formRequiredItem) {
                formRequiredItem.classList.remove("error");
                formRequiredItem.parentElement.classList.remove("error");
                if (formRequiredItem.parentElement.querySelector(".error")) formRequiredItem.parentElement.querySelector(".error").classList.remove("error");
            },
            formClean(form) {
                form.reset();
                setTimeout((() => {
        ...
        const inputMasks = document.querySelectorAll(".popup__phone");
        if (inputMasks.length) modules_flsModules.inputmask = Inputmask("+7 (999) 999-9999").mask(inputMasks);
