(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".feature-slider")) new core(".feature-slider", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".about__swiper")) new core(".about__swiper", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".certificate__swiper")) new core(".certificate__swiper", {
            modules: [ Navigation, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    $(window).scroll("load", (function() {
        ...
        let parallax = $(".services").offset().top;
        ...
        if ($(window).scrollTop() >= parallax) {
            $(".offer").css({
                "background-position-y": "+" + 0 * st + "px"
            });
            $(".offer__title").css({
                transform: "translate(0%, " + 0 * st + "%"
            });
        }
    }));
    window["FLS"] = true;
