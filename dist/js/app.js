(() => {
    ...
    (() => {
        ...
        class SelectConstructor {
            constructor(props, data = null) {
                ...
                if (this.config.init) {
                    ...
                    } else this.setLogging("Сплю, нет выбора select");
                }
            }
        ...
        function rangeInit() {
            ...
            let sliderStep = document.querySelector(".count");
            let sliderValueInput = document.getElementById("sliderValueInput");
            if (priceSlider) {
                ...
                priceSlider.noUiSlider.on("update", (function(values, handle) {
                    sliderStep.innerHTML = values[handle];
        ...
        let burgerMenu = document.querySelector(".hamburger-button");
